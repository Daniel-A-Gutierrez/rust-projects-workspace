...
use generic_array::{ArrayLength, ConstArrayLength, GenericArray as Array, IntoArrayLength};
use rand::Rng;
...
fn bubble_sort_vec(arr: &mut [i32; 32])
{
    ...
    const even_swap: [usize; 32] = [0, 33, 2, 35, 4, 37, 6, 39, 8, 41, 10, 43, 12, 45, 14, 47, 16,
                                    49, 18, 51, 20, 53, 22, 55, 24, 57, 26, 59, 28, 61, 30, 63];
